...
// pixel-perfect.
func renderSplitFileTree(t Theme, in splitTreeInput) string {
	...
	divider := renderSplitDivider(t, in.botFocused, contentWidth, in.botFiles, in.botCursor)
	...
	return renderPanel(t, body, title, focused, contentWidth, in.height, hasAbove, hasBelow)
}
